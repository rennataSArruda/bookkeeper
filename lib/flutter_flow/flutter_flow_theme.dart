...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF6EC6FF);
  late Color secondary = const Color(0xFFB0E2FF);
  late Color tertiary = const Color(0xFFA4D8FF);
  late Color alternate = const Color(0xFF88CCFF);
  ...
  late Color accent3 = const Color(0xFFFF7043);
  ...
  late Color nonPhotoBlue = Color(0xFF99CDD1);
  late Color lightBlue = Color(0xFFBEDCDF);
  late Color azureWeb = Color(0xFFE5F3F4);
  late Color slateGray = Color(0xFF718A96);
